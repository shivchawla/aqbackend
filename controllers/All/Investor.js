...
* @Last Modified time: 2018-03-09 16:12:05
*/
...
module.exports.updateInvestorDefaultPortfolio = function(req, res, next) {
	Investor.updateInvestorDefaultPortfolio(req.swagger.params, res, next);
};
