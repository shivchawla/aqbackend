...
* @Last Modified time: 2018-02-28 10:38:23
*/
...
module.exports.getPortfolioPerformance = function getPortfolioPerformance(req, res, next) {
	Portfolio.getPortfolioPerformance(req.swagger.params, res, next);
};*/
